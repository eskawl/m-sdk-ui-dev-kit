...
import LabeledCard from '../labeled-card/labeled-card'
...
const LogsCard = ({
  ...
  const renderSkeleton = (): JSX.Element => (
    <div className="mining-sdk-logs-card__skeleton-row">
  ...
  const renderEmptyState = (): JSX.Element => (
    <div className="mining-sdk-logs-card__empty">
  ...
  return (
    <LabeledCard label={label} isDark={isDark}>
      {isLoading ? (
        ...
        <div className="mining-sdk-logs-card__inner-container">
          <div
            className={cn(
              'mining-sdk-logs-card__list-container',
              isEmpty && 'mining-sdk-logs-card__list-container--empty',
            )}
          >
          ...
          {pagination && !isPaginationHidden && (
            <Pagination
              ...
              className="mining-sdk-logs-card__pagination"
