...
describe('baseStatusIndicator', () => {
  it('renders active state with check icon', () => {
    ...
    expect(container.querySelector('.mining-sdk-status-indicator--active')).toBeInTheDocument()
  ...
  it('renders inactive state with cross icon', () => {
    ...
    expect(container.querySelector('.mining-sdk-status-indicator--inactive')).toBeInTheDocument()
    expect(container.querySelector('svg')).toBeInTheDocument()
  })
  ...
  it('applies custom color when active', () => {
    ...
    const icon = container.querySelector('.mining-sdk-status-indicator__icon')
  ...
  it('applies flash type class when inactive', () => {
    ...
    expect(container.querySelector('.mining-sdk-status-indicator__icon--flash')).toBeInTheDocument()
  })

  it('applies sound type class when inactive', () => {
    const { container } = render(<BaseStatusIndicator isActive={false} type="sound" />)

    expect(container.querySelector('.mining-sdk-status-indicator__icon--sound')).toBeInTheDocument()
  })
  ...
  it('does not apply type class when active', () => {
    ...
    expect(
      container.querySelector('.mining-sdk-status-indicator__icon--flash'),
    ).not.toBeInTheDocument()
    expect(
      container.querySelector('.mining-sdk-status-indicator__icon--sound'),
    ).not.toBeInTheDocument()
  })
})
