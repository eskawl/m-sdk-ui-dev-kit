...
import { cn, formatErrors, formatNumber, SimpleTooltip, unitToKilo } from '@mining-sdk/core'
import type { ErrorWithTimestamp } from '@mining-sdk/core'
...
export const WidgetTopRow = ({
  ...
  return (
    <div className={cn('mining-sdk-widget-top-row', className)}>
      <div className="mining-sdk-widget-top-row__inner">
        <div className="mining-sdk-widget-top-row__title">{title}</div>
        ...
        <div className="mining-sdk-widget-top-row__power">
          {statsErrorMessage ? (
