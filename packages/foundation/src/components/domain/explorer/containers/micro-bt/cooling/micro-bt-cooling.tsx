...
export const MicroBTCooling = ({ data }: MicroBTCoolingProps): ReactElement | null => {
  ...
  return (
    <div className="mining-sdk-micro-bt-cooling">
      {/* Cycle Pump */}
      <div className="mining-sdk-micro-bt-cooling__section">
        <div className="mining-sdk-micro-bt-cooling__item-row">
          <span className="mining-sdk-micro-bt-cooling__label">Cycle Pump</span>
      ...
      <div className="mining-sdk-micro-bt-cooling__divider" />

      {/* Main Circulation Pump */}
      <div className="mining-sdk-micro-bt-cooling__section">
        <h4 className="mining-sdk-micro-bt-cooling__section-title">Main Circulation Pump</h4>
        <div className="mining-sdk-micro-bt-cooling__row">
          <div className="mining-sdk-micro-bt-cooling__item">
            <span className="mining-sdk-micro-bt-cooling__label">Status</span>
          ...
          <div className="mining-sdk-micro-bt-cooling__item">
            <span className="mining-sdk-micro-bt-cooling__label">Switch State</span>
            <span className="mining-sdk-micro-bt-cooling__value">
              {cdu?.circulation_pump_switch || '--'}
            </span>
          </div>

          <div className="mining-sdk-micro-bt-cooling__item">
            <span className="mining-sdk-micro-bt-cooling__label">Speed</span>
            <span className="mining-sdk-micro-bt-cooling__value">
      ...
      {/* Cooling Fan */}
      <div className="mining-sdk-micro-bt-cooling__section">
        <h4 className="mining-sdk-micro-bt-cooling__section-title">Cooling Fan</h4>
        <div className="mining-sdk-micro-bt-cooling__row">
          <div className="mining-sdk-micro-bt-cooling__item">
            <span className="mining-sdk-micro-bt-cooling__label">Status</span>
      ...
      {/* Make Up Pump */}
      <div className="mining-sdk-micro-bt-cooling__section">
        <h4 className="mining-sdk-micro-bt-cooling__section-title">Make Up Pump</h4>
        <div className="mining-sdk-micro-bt-cooling__row">
          <div className="mining-sdk-micro-bt-cooling__item">
            <span className="mining-sdk-micro-bt-cooling__label">Status</span>
            <Indicator
