...
export const FireStatusBox = ({ data }: FireStatusBoxProps): ReactElement => {
  ...
  return (
    <div className="mining-sdk-fire-status-box">
      <div className="mining-sdk-fire-status-box__item">
        <span className="mining-sdk-fire-status-box__label">Smoke Detector 1</span>
      ...
      <div className="mining-sdk-fire-status-box__item">
        <span className="mining-sdk-fire-status-box__label">Water Ingress Detector</span>
      ...
      <div className="mining-sdk-fire-status-box__item">
        <span className="mining-sdk-fire-status-box__label">Fan Status</span>
