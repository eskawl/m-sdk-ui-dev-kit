...
export const BitMainImmersionUnitControlBox = ({
  ...
  const FrequencyItem = frequency != null && (
    <div className="mining-sdk-bitmain-immersion-unit-control-box__item">
      <span className="mining-sdk-bitmain-immersion-unit-control-box__item-label">Frequency</span>
      <span className="mining-sdk-bitmain-immersion-unit-control-box__item-value">
  ...
  return (
    <BitMainImmersionControlBox
      ...
      rightContent={
        <div className="mining-sdk-bitmain-immersion-unit-control-box">
          <Tag color={alarmStatus ? 'red' : 'green'}>{alarmStatus ? 'Fault' : 'Normal'}</Tag>

          <div className="mining-sdk-bitmain-immersion-unit-control-box__item">
            <span className="mining-sdk-bitmain-immersion-unit-control-box__item-label">
              {unitTitle || 'Status'}
            </span>
