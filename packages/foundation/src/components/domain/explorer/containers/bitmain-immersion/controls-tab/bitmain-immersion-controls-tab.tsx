...
export const BitMainControlsTab = ({ data }: BitMainControlsTabProps): ReactElement => {
  ...
  return (
    <div className="mining-sdk-bitmain-controls-tab">
      {/* Fan Status */}
      <div className="mining-sdk-bitmain-controls-tab__section">
        <div className="mining-sdk-bitmain-controls-tab__section-header">
          <span className="mining-sdk-bitmain-controls-tab__section-label">Container Fan</span>
      ...
      {/* Tank Levels */}
      <div className="mining-sdk-bitmain-controls-tab__section">
        <h3 className="mining-sdk-bitmain-controls-tab__title">Tank Levels</h3>
        <div className="mining-sdk-bitmain-controls-tab__grid">
          {tanks.map(({ name, level }) => (
            <div key={name} className="mining-sdk-bitmain-controls-tab__item">
              <span className="mining-sdk-bitmain-controls-tab__label">{name}</span>
              <span className="mining-sdk-bitmain-controls-tab__value">
                {level != null ? `${level} cm` : '--'}
              </span>
            </div>
          ))}
      ...
      {/* Location */}
      <div className="mining-sdk-bitmain-controls-tab__section">
        <h3 className="mining-sdk-bitmain-controls-tab__title">GPS Location</h3>
        <div className="mining-sdk-bitmain-controls-tab__grid">
          <div className="mining-sdk-bitmain-controls-tab__location">
            <span className="mining-sdk-bitmain-controls-tab__location-label">Latitude</span>
            <span className="mining-sdk-bitmain-controls-tab__location-value">
              {safeString(containerSpecific?.latitude) || '--'}
            </span>
            <span className="mining-sdk-bitmain-controls-tab__location-dir">
              {safeString(containerSpecific?.latitude_direction) || '--'}
            </span>
          </div>
          <div className="mining-sdk-bitmain-controls-tab__location">
            <span className="mining-sdk-bitmain-controls-tab__location-label">Longitude</span>
            <span className="mining-sdk-bitmain-controls-tab__location-value">
