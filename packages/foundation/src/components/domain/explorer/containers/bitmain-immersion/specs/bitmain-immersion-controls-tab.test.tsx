...
describe('bitMainControlsTab', () => {
  ...
  it('renders without crashing', () => {
    ...
    expect(document.querySelector('.mining-sdk-bitmain-controls-tab')).toBeInTheDocument()
  })
  ...
  describe('structure', () => {
    it('has three main sections', () => {
      ...
      const sections = container.querySelectorAll('.mining-sdk-bitmain-controls-tab__section')
