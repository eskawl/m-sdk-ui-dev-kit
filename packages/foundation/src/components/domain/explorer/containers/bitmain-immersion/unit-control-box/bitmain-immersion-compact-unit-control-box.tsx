...
export const BitMainImmersionCompactUnitControlBox = ({
  ...
  return (
    <BitMainImmersionControlBox
      ...
      className={className}
      rightContent={
        <div className="mining-sdk-bitmain-immersion-compact-unit-control-box">
          <div
            className={`mining-sdk-bitmain-immersion-compact-unit-control-box__primary ${
              isOpen
                ? 'mining-sdk-bitmain-immersion-compact-unit-control-box__primary--open'
                : 'mining-sdk-bitmain-immersion-compact-unit-control-box__primary--closed'
            }`}
          >
            {isOpen ? 'Open' : 'Closed'}
          </div>
          ...
          {opening && (
            <div className="mining-sdk-bitmain-immersion-compact-unit-control-box__transition">
              Opening
            </div>
          )}
