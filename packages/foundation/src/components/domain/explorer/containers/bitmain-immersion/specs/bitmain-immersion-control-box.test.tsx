...
describe('bitMainImmersionControlBox', () => {
  it('renders without crashing', () => {
    ...
    expect(document.querySelector('.mining-sdk-bitmain-immersion-control-box')).toBeInTheDocument()
  })
  ...
  it('does not render bottom row when no bottom content', () => {
    ...
    expect(
      container.querySelector('.mining-sdk-bitmain-immersion-control-box__bottom'),
  ...
  it('applies secondary variant class', () => {
    ...
    expect(
      container.querySelector('.mining-sdk-bitmain-immersion-control-box--secondary'),
    ).toBeInTheDocument()
  })
  ...
  it('applies secondary class to left column', () => {
    const { container } = render(<BitMainImmersionControlBox secondary />)
    expect(
      container.querySelector('.mining-sdk-bitmain-immersion-control-box__left--secondary'),
    ).toBeInTheDocument()
  })
  ...
  it('applies secondary class to right column', () => {
    const { container } = render(<BitMainImmersionControlBox secondary />)
    expect(
      container.querySelector('.mining-sdk-bitmain-immersion-control-box__right--secondary'),
    ).toBeInTheDocument()
  })
  ...
  it('has correct structure with top section', () => {
    const { container } = render(<BitMainImmersionControlBox />)
    expect(
      container.querySelector('.mining-sdk-bitmain-immersion-control-box__top'),
    ).toBeInTheDocument()
  })
  ...
  it('has left and right columns in top section', () => {
    const { container } = render(<BitMainImmersionControlBox />)
    expect(
      container.querySelector('.mining-sdk-bitmain-immersion-control-box__left'),
    ).toBeInTheDocument()
    expect(
      container.querySelector('.mining-sdk-bitmain-immersion-control-box__right'),
    ).toBeInTheDocument()
  })
})
