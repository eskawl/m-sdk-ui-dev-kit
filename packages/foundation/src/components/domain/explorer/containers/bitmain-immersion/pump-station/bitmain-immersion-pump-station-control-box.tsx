...
export const BitMainImmersionPumpStationControlBox = ({
  ...
  return (
    <div className={`mining-sdk-bitmain-immersion-pump-station-control-box ${className || ''}`}>
      {title && (
        <h3 className="mining-sdk-bitmain-immersion-pump-station-control-box__title">{title}</h3>
      )}

      <div className="mining-sdk-bitmain-immersion-pump-station-control-box__content">
        {/* Alarm Status */}
        <div className="mining-sdk-bitmain-immersion-pump-station-control-box__status">
        ...
        {ready !== undefined && (
          <div
            className={`mining-sdk-bitmain-immersion-pump-station-control-box__state ${
              ready
                ? 'mining-sdk-bitmain-immersion-pump-station-control-box__state--on'
                : 'mining-sdk-bitmain-immersion-pump-station-control-box__state--off'
            }`}
          >
