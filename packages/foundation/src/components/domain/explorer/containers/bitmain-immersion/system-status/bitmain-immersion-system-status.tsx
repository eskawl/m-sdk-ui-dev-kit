...
export const BitMainImmersionSystemStatus = ({
  ...
  return (
    <div className="mining-sdk-bitmain-immersion-system-status">
      <div className="mining-sdk-bitmain-immersion-system-status__header">
        <h3 className="mining-sdk-bitmain-immersion-system-status__title">System Status</h3>
      </div>

      <div className="mining-sdk-bitmain-immersion-system-status__content">
        {serverOn && (
          <div className="mining-sdk-bitmain-immersion-system-status__item">
            <span className="mining-sdk-bitmain-immersion-system-status__label">Server Start</span>
        ...
        <div className="mining-sdk-bitmain-immersion-system-status__item">
          <span className="mining-sdk-bitmain-immersion-system-status__label">Connection</span>
