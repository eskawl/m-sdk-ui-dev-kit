...
describe('BitMainImmersionSystemStatus', () => {
  ...
  it('renders without crashing', () => {
    ...
    expect(
      document.querySelector('.mining-sdk-bitmain-immersion-system-status'),
    ).toBeInTheDocument()
  })
  ...
  it('has correct structure with header and content', () => {
    ...
    expect(
      container.querySelector('.mining-sdk-bitmain-immersion-system-status__header'),
    ).toBeInTheDocument()
    expect(
      container.querySelector('.mining-sdk-bitmain-immersion-system-status__content'),
    ).toBeInTheDocument()
  })
})
