...
export const BitMainImmersionControlBox = ({
  ...
  return (
    <div
      className={`mining-sdk-bitmain-immersion-control-box ${
        secondary ? 'mining-sdk-bitmain-immersion-control-box--secondary' : ''
      } ${className || ''}`}
    >
      <div className="mining-sdk-bitmain-immersion-control-box__top">
        <div
          className={`mining-sdk-bitmain-immersion-control-box__left ${
            secondary ? 'mining-sdk-bitmain-immersion-control-box__left--secondary' : ''
          }`}
        >
          {title && <h3 className="mining-sdk-bitmain-immersion-control-box__title">{title}</h3>}
          {leftContent}
        </div>
        <div
          className={`mining-sdk-bitmain-immersion-control-box__right ${
            secondary ? 'mining-sdk-bitmain-immersion-control-box__right--secondary' : ''
          }`}
        >
          {rightContent}
        </div>
      ...
      {bottomContent && (
        <div className="mining-sdk-bitmain-immersion-control-box__bottom">{bottomContent}</div>
      )}
    </div>
  )
}
