...
describe('BitMainImmersionPumpStationControlBox', () => {
  it('renders without crashing', () => {
    ...
    expect(
      document.querySelector('.mining-sdk-bitmain-immersion-pump-station-control-box'),
    ).toBeInTheDocument()
  })
  ...
  it('applies on state class when status is true', () => {
    ...
    expect(
      container.querySelector('.mining-sdk-bitmain-immersion-pump-station-control-box__state--on'),
    ).toBeInTheDocument()
  })
  ...
  it('applies off state class when status is false', () => {
    ...
    expect(
      container.querySelector('.mining-sdk-bitmain-immersion-pump-station-control-box__state--off'),
    ).toBeInTheDocument()
  })
