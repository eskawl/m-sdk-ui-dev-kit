...
describe('SingleStatCard', () => {
  ...
  it('applies primary variant class', () => {
    ...
    expect(container.querySelector('.mining-sdk-single-stat-card--primary')).toBeInTheDocument()
  })

  it('applies secondary variant class', () => {
    const { container } = render(<SingleStatCard name="Test" value={123} variant="secondary" />)

    expect(container.querySelector('.mining-sdk-single-stat-card--secondary')).toBeInTheDocument()
  })

  it('applies tertiary variant class', () => {
    const { container } = render(<SingleStatCard name="Test" value={123} variant="tertiary" />)

    expect(container.querySelector('.mining-sdk-single-stat-card--tertiary')).toBeInTheDocument()
  })

  it('applies row class', () => {
    const { container } = render(<SingleStatCard name="Test" value={123} row />)

    expect(container.querySelector('.mining-sdk-single-stat-card--row')).toBeInTheDocument()
  })

  it('applies flash class', () => {
    const { container } = render(<SingleStatCard name="Test" value={123} flash />)

    expect(container.querySelector('.mining-sdk-single-stat-card--flash')).toBeInTheDocument()
  })

  it('applies superflash class', () => {
    const { container } = render(<SingleStatCard name="Test" value={123} superflash />)

    expect(container.querySelector('.mining-sdk-single-stat-card--superflash')).toBeInTheDocument()
  })

  it('applies long value class for long values', () => {
    const { container } = render(<SingleStatCard name="Test" value="1234567" />)

    expect(container.querySelector('.mining-sdk-single-stat-card--long-value')).toBeInTheDocument()
  })
  ...
  it('does not apply long value class for short values', () => {
    ...
    expect(
      container.querySelector('.mining-sdk-single-stat-card--long-value'),
  ...
  it('sets custom color as CSS variable', () => {
    ...
    const card = container.querySelector('.mining-sdk-single-stat-card')
