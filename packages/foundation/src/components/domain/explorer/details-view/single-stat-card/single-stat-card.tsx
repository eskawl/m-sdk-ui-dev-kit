...
export const SingleStatCard = ({
  ...
  const renderContent = (): ReactNode => {
    const textContent = (
      <>
        <div className="mining-sdk-single-stat-card__name">{name}</div>
        {subtitle && <div className="mining-sdk-single-stat-card__subtitle">{subtitle}</div>}
      </>
    )
    ...
    return (
      <div
        className={cn(
          'mining-sdk-single-stat-card',
          variant && `mining-sdk-single-stat-card--${variant}`,
          flash && 'mining-sdk-single-stat-card--flash',
          superflash && 'mining-sdk-single-stat-card--superflash',
          row && 'mining-sdk-single-stat-card--row',
          isLongValue && 'mining-sdk-single-stat-card--long-value',
        )}
      ...
      >
        {variant === 'primary' ? (
          ...
          <div className="mining-sdk-single-stat-card__text">{textContent}</div>
        )}
        <div className="mining-sdk-single-stat-card__value">{valueFormatted}</div>
      </div>
    )
  }
