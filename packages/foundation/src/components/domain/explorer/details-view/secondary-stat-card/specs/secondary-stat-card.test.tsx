...
describe('SecondaryStatCard', () => {
  ...
  it('renders with correct structure', () => {
    ...
    expect(container.querySelector('.mining-sdk-secondary-stat-card')).toBeInTheDocument()
    expect(container.querySelector('.mining-sdk-secondary-stat-card__name')).toBeInTheDocument()
    expect(container.querySelector('.mining-sdk-secondary-stat-card__value')).toBeInTheDocument()
  })
