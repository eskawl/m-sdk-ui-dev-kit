...
describe('MinerMetricCard', () => {
  ...
  describe('efficiency display', () => {
    ...
    it('has correct CSS class for efficiency', () => {
      ...
      expect(
        container.querySelector('.mining-sdk-miner-metric-card__efficiency'),
      ).toBeInTheDocument()
    })
  })
  ...
  describe('secondary stats', () => {
    ...
    it('does not render secondary stats when array is empty', () => {
      ...
      const { container } = render(<MinerMetricCard primaryStats={mockPrimaryStats} />)
      expect(
        container.querySelector('.mining-sdk-miner-metric-card__grid-box'),
    ...
    it('has correct CSS class for grid box', () => {
      ...
      expect(container.querySelector('.mining-sdk-miner-metric-card__grid-box')).toBeInTheDocument()
    })
  })
  ...
  describe('CSS classes', () => {
    it('has correct class for content wrapper', () => {
      ...
      expect(container.querySelector('.mining-sdk-miner-metric-card__content')).toBeInTheDocument()
    })

    it('has correct class for boxes', () => {
      const { container } = render(<MinerMetricCard primaryStats={mockPrimaryStats} />)

      const boxes = container.querySelectorAll('.mining-sdk-miner-metric-card__box')
    ...
    it('has correct class for items', () => {
      ...
      const items = container.querySelectorAll('.mining-sdk-miner-metric-card__item')
    ...
    it('has correct class for labels', () => {
      ...
      const labels = container.querySelectorAll('.mining-sdk-miner-metric-card__label')
    ...
    it('has correct class for values', () => {
      ...
      const values = container.querySelectorAll('.mining-sdk-miner-metric-card__value')
