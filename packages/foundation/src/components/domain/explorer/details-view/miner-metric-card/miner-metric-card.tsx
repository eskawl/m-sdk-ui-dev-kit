  ...
  return (
    <div className="mining-sdk-miner-metric-card" data-testid="card">
      ...
      <div className="mining-sdk-miner-metric-card__body">
        {showEfficiency && (
          <div className="mining-sdk-miner-metric-card__efficiency">
            <div className="mining-sdk-miner-metric-card__label">{labels.efficiency}</div>
            <div className="mining-sdk-miner-metric-card__value">
              {`${formatNumber(efficiencyValue.value)} ${efficiencyValue.unit || ''}`}
            </div>
          </div>
        )}

        <div className="mining-sdk-miner-metric-card__content">
          <div className="mining-sdk-miner-metric-card__box">
            <div className="mining-sdk-miner-metric-card__item">
              <div className="mining-sdk-miner-metric-card__label">{labels.hashRate}</div>
              <div className="mining-sdk-miner-metric-card__value">
                {hashRateValue ? `${hashRateValue.value || '-'} ${hashRateValue.unit}` : '-'}
              </div>
            </div>
            <div className="mining-sdk-miner-metric-card__item">
              <div className="mining-sdk-miner-metric-card__label">{labels.temperature}</div>
              <div className="mining-sdk-miner-metric-card__value">
          ...
          <div className="mining-sdk-miner-metric-card__box">
            <div className="mining-sdk-miner-metric-card__item">
              <div className="mining-sdk-miner-metric-card__label">{labels.frequency}</div>
              <div className="mining-sdk-miner-metric-card__value">
                {`${formattedFrequency || ''} ${frequencyValue?.unit || ''}`}
              </div>
            </div>
            <div className="mining-sdk-miner-metric-card__item">
              <div className="mining-sdk-miner-metric-card__label">{labels.consumption}</div>
              <div className="mining-sdk-miner-metric-card__value">
          ...
          {showSecondaryStats && secondaryStats && secondaryStats.length > 0 && (
            <div className="mining-sdk-miner-metric-card__grid-box">
              {secondaryStats.map(({ name, value }) => (
                <div key={name} className="mining-sdk-miner-metric-card__item">
                  <div className="mining-sdk-miner-metric-card__label">{name}</div>
                  <div className="mining-sdk-miner-metric-card__value">{value}</div>
                </div>
              ))}
            </div>
          )}
