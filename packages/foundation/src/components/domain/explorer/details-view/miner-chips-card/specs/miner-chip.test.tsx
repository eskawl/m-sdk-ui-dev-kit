...
describe('MinerChip', () => {
  ...
  describe('rendering', () => {
    it('renders chip container', () => {
      ...
      expect(container.querySelector('.mining-sdk-miner-chip')).toBeInTheDocument()
    })
    ...
    it('has correct CSS class for title', () => {
      const { container } = render(<MinerChip {...mockProps} />)
      expect(container.querySelector('.mining-sdk-miner-chip__title')).toBeInTheDocument()
    })

    it('has correct CSS class for property labels', () => {
      const { container } = render(<MinerChip {...mockProps} />)
      const properties = container.querySelectorAll('.mining-sdk-miner-chip__property')
      expect(properties).toHaveLength(2)
    })

    it('has correct CSS class for values', () => {
      const { container } = render(<MinerChip {...mockProps} />)
      const values = container.querySelectorAll('.mining-sdk-miner-chip__value')
      expect(values.length).toBeGreaterThan(0)
    })

    it('has correct CSS class for minmax container', () => {
      const { container } = render(<MinerChip {...mockProps} />)
      expect(container.querySelector('.mining-sdk-miner-chip__minmax')).toBeInTheDocument()
    })
  })
  ...
  describe('CSS classes', () => {
    it('applies value-type class to min label', () => {
      const { container } = render(<MinerChip {...mockProps} />)
      const minLabel = Array.from(
        container.querySelectorAll('.mining-sdk-miner-chip__value-type'),
      ).find((el) => el.textContent?.includes('min'))
      expect(minLabel).toBeInTheDocument()
    })

    it('applies value-type class to max label', () => {
      const { container } = render(<MinerChip {...mockProps} />)
      const maxLabel = Array.from(
        container.querySelectorAll('.mining-sdk-miner-chip__value-type'),
      ).find((el) => el.textContent?.includes('max'))
  ...
  describe('structure', () => {
    it('renders title before temperature', () => {
      const { container } = render(<MinerChip {...mockProps} />)
      const elements = Array.from(container.querySelectorAll('.mining-sdk-miner-chip > *'))
      const titleIndex = elements.findIndex((el) =>
        el.classList.contains('mining-sdk-miner-chip__title'),
      )
      const tempIndex = elements.findIndex(
        (el) =>
          el.textContent === 'Temperature' &&
          el.classList.contains('mining-sdk-miner-chip__property'),
      )
    ...
    it('renders minmax container between temperature sections', () => {
      const { container } = render(<MinerChip {...mockProps} />)
      const minmax = container.querySelector('.mining-sdk-miner-chip__minmax')
    ...
    it('minmax container has two value children', () => {
      const { container } = render(<MinerChip {...mockProps} />)
      const minmax = container.querySelector('.mining-sdk-miner-chip__minmax')
      const values = minmax?.querySelectorAll('.mining-sdk-miner-chip__value')
