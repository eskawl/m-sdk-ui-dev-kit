...
describe('MinerChipsCard', () => {
  ...
  describe('rendering', () => {
    it('renders card container when chips exist', () => {
      ...
      expect(container.querySelector('.mining-sdk-miner-chips-card')).toBeInTheDocument()
    })
    ...
    it('renders chips container', () => {
      const { container } = render(<MinerChipsCard data={mockData} />)
      expect(container.querySelector('.mining-sdk-miner-chips-card__chips')).toBeInTheDocument()
    })

    it('applies correct CSS class to label', () => {
      const { container } = render(<MinerChipsCard data={mockData} />)
      expect(container.querySelector('.mining-sdk-miner-chips-card__label')).toBeInTheDocument()
    })
  ...
  describe('empty data handling', () => {
    it('does not render when frequency chips is empty', () => {
      ...
      expect(container.querySelector('.mining-sdk-miner-chips-card')).not.toBeInTheDocument()
    })
