...
export const ContainerCharts = ({
  ...
  if (!featureEnabled) {
    return (
      <div className="mining-sdk-container-charts" data-testid="container-charts-root">
  ...
  return (
    <div className="mining-sdk-container-charts" data-testid="container-charts-root">
      {title ? <h1 className="mining-sdk-container-charts__title">{title}</h1> : null}

      {isLoadingCombinations ? (
        <div
          className="mining-sdk-container-charts__loading"
          data-testid="container-charts-combos-loading"
        >
          <Spinner />
        </div>
      ) : (
        <div className="mining-sdk-container-charts__select-row">
          <span className="mining-sdk-container-charts__select-label">Select combination:</span>
          <select
            className="mining-sdk-container-charts__select"
      ...
      {selectedCombination ? (
        <div className="mining-sdk-container-charts__layout" data-testid="container-charts-panel">
          {isBitdeer(selectedCombination) ? (
            <div className="mining-sdk-container-charts__chart-block">
              <div className="mining-sdk-container-charts__chart-title">Liquid Temp H</div>
              <LineChartCard
                title="Liquid Temp H"
          ...
          <div className="mining-sdk-container-charts__chart-block">
            <div className="mining-sdk-container-charts__chart-title">Liquid Temp L</div>
            <LineChartCard
              title="Liquid Temp L"
              rawData={chartRawData}
              dataAdapter={(raw) =>
          ...
          {!isMicroBT(selectedCombination) && !isAntspaceHydro(selectedCombination) ? (
            <div className="mining-sdk-container-charts__chart-block">
              <div className="mining-sdk-container-charts__chart-title">Oil Temp</div>
              <LineChartCard
                title="Oil Temp"
                rawData={chartRawData}
                dataAdapter={(raw) =>
          ...
          {!isAntspaceImmersion(_replace(selectedCombination, '_', '-')) ? (
            <div className="mining-sdk-container-charts__chart-block">
              <div className="mining-sdk-container-charts__chart-title">Pressure</div>
              <LineChartCard
                title="Pressure"
                rawData={chartRawData}
                dataAdapter={(raw) =>
