...
const renderRoot = (props: BitMainImmersionSummaryBoxProps = {}) => {
  ...
  return container.querySelector('.mining-sdk-bitmain-immersion-summary-box') as HTMLElement
}
...
describe('BitMainImmersionSummaryBox', () => {
  describe('rendering', () => {
    ...
    it('should render root, pump section, and liquid stat cards', () => {
      ...
      expect(
        root.querySelector('.mining-sdk-bitmain-immersion-summary-box__pumps'),
      ).toBeInTheDocument()
      expect(
        root.querySelector('.mining-sdk-bitmain-immersion-summary-box__liquid-stats'),
      ).toBeInTheDocument()
  ...
  describe('CSS structure', () => {
    it('should apply pump grid and liquid stats grid classes', () => {
      ...
      expect(root.querySelectorAll('.mining-sdk-bitmain-immersion-summary-box__pump')).toHaveLength(
        3,
      )
      expect(
        root.querySelector('.mining-sdk-bitmain-immersion-summary-box__liquid-stats'),
