...
export const BitMainImmersionSummaryBox = ({
  ...
  return (
    <div className="mining-sdk-bitmain-immersion-summary-box">
      <div className="mining-sdk-bitmain-immersion-summary-box__pumps">
        <div className="mining-sdk-bitmain-immersion-summary-box__pump">
          <span className="mining-sdk-bitmain-immersion-summary-box__pump-title">Oil Pump #1</span>
          <Indicator color={pumpStatusToIndicatorColor(oilPump1Status)} size="md">
            {oilPump1Status}
          </Indicator>
        </div>
        <div className="mining-sdk-bitmain-immersion-summary-box__pump">
          <span className="mining-sdk-bitmain-immersion-summary-box__pump-title">Oil Pump #2</span>
          <Indicator color={pumpStatusToIndicatorColor(oilPump2Status)} size="md">
            {oilPump2Status}
          </Indicator>
        </div>
        <div className="mining-sdk-bitmain-immersion-summary-box__pump">
          <span className="mining-sdk-bitmain-immersion-summary-box__pump-title">Water pump</span>
      ...
      <div className="mining-sdk-bitmain-immersion-summary-box__liquid-stats">
        <SingleStatCard
          variant="secondary"
