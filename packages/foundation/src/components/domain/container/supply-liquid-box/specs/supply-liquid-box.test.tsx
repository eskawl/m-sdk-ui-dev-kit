...
const renderRoot = (props: SupplyLiquidBoxProps = {}) => {
  ...
  return container.querySelector('.mining-sdk-supply-liquid-box') as HTMLElement
}
...
describe('SupplyLiquidBox', () => {
  describe('rendering', () => {
    ...
    it('should render root and stat grid', () => {
      ...
      expect(root.querySelector('.mining-sdk-supply-liquid-box__stats')).toBeInTheDocument()
