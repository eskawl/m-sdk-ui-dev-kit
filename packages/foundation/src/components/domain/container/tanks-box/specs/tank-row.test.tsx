...
const renderRoot = (props: Partial<TankRowProps> = {}) => {
  ...
  return container.querySelector('.mining-sdk-tanks-box__row') as HTMLElement
}
...
describe('TankRow', () => {
  describe('rendering', () => {
    it('should render label and temperature', () => {
      ...
      const tempValue = root.querySelector('.mining-sdk-tanks-box__param-value')
    ...
    it('should set data-flash on label and value when flash is true', () => {
      ...
      const label = root.querySelector('.mining-sdk-tanks-box__param-label')
      const value = root.querySelector('.mining-sdk-tanks-box__param-value')
  ...
  describe('pressure', () => {
    ...
    it('should render pressure block when pressure.value is provided', () => {
      ...
      const paramValues = root.querySelectorAll('.mining-sdk-tanks-box__param-value')
  ...
  describe('CSS structure', () => {
    it('should apply row and param CSS classes', () => {
      ...
      expect(root).toHaveClass('mining-sdk-tanks-box__row')
      expect(root.querySelector('.mining-sdk-tanks-box__params')).toBeInTheDocument()
      expect(root.querySelectorAll('.mining-sdk-tanks-box__param').length).toBeGreaterThanOrEqual(1)
      expect(root.querySelector('.mining-sdk-tanks-box__pump-statuses')).toBeInTheDocument()
      expect(root.querySelectorAll('.mining-sdk-tanks-box__pump-status')).toHaveLength(2)
    })
  })
})
