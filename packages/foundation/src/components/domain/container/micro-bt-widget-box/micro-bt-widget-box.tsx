...
export const MicroBTWidgetBox = ({ data }: MicroBTWidgetBoxProps): ReactElement | null => {
  ...
  return (
    <div className="mining-sdk-micro-bt-widget-box">
      <div className="mining-sdk-micro-bt-widget-box__item">
        <span className="mining-sdk-micro-bt-widget-box__title">Cicle Pump</span>
        <Indicator color={cyclePumpRunning ? 'green' : 'gray'} size="md">
          {cyclePumpRunning ? DEVICE_STATUS.RUNNING : DEVICE_STATUS.OFF}
        </Indicator>
      </div>
      <div className="mining-sdk-micro-bt-widget-box__item">
        <span className="mining-sdk-micro-bt-widget-box__title">Cooling Fan</span>
