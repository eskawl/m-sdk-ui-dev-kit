...
const renderRoot = (props: MicroBTWidgetBoxProps = {}) => {
  ...
  return container.querySelector('.mining-sdk-micro-bt-widget-box') as HTMLElement
}
...
describe('MicroBTWidgetBox', () => {
  describe('rendering', () => {
    ...
    it('should render two item columns with title styling hook', () => {
      ...
      expect(root.querySelectorAll('.mining-sdk-micro-bt-widget-box__item')).toHaveLength(2)
      expect(root.querySelectorAll('.mining-sdk-micro-bt-widget-box__title')).toHaveLength(2)
    })
  })
