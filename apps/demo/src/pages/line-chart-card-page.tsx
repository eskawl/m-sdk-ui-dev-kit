...
import { LineChartCard } from '@mining-sdk/foundation'
import type { LineChartCardData } from '@mining-sdk/foundation'
  ...
  return (
    <section className="demo-section">
      ...
      <p style={{ color: 'var(--color-text-secondary)', marginBottom: '1.5rem' }}>
        ...
        footer. Part of <code>@mining-sdk/foundation</code>.
      </p>
