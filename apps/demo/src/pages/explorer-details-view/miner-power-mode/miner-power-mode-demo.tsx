...
export const MinerPowerModeDemo = (): ReactElement => {
  ...
  const handleSetPowerMode = (devices: Device[], mode: string) => {
    ...
    alert(`Action: Set ${mode} for ${devices.length} devices of model ${devices[0]?.model}`)
  }

  return (
    <div className="miner-power-mode-demo">
      <div className="miner-power-mode-demo__header">
        <h1>Miner Power Mode Management</h1>
        <p>Demonstrating Selection Button components.</p>
      </div>
